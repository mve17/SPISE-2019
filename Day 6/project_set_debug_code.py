...
#Printing Dots
smallnumberfromuser = input('Enter a number between 0 and 20: ')
smallnumberfromuser = smallnumberfromuser * 2
for i in range(smallnumberframuser / 2)
    print('.')
...
def generate_word():
    ...
    for x in range(word_size):
        output.append(generate_letter)
    return output

def generate_paragraph():
    par_size=random.randint(10,max_par_size)
    output=''
